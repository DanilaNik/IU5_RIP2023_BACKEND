...
func (a *Application) Run() {
	...
	// docs.SwaggerInfo.Host = "172.20.10.6:8080"
	...
	a.Router.DELETE("/orders/delete", a.Handler.DeleteRequest)
	...
	a.Router.Use(a.Handler.UserAuth).POST("/validate", a.Handler.Validate)
